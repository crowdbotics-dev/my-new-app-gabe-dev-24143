...
## Project Structure
    ...
    ├── my_new_app_gabe_dev_24143  # Django project configurations
...
1. Clone this repo and `cd my_new_app_gabe_dev_24143`
...
2. Clone this repo and `cd my_new_app_gabe_dev_24143`
